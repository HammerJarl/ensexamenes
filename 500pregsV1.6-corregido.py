...
def mostrar_pantalla_carga(root):
    ...
    print(f"Ruta de splash_image_path: {splash_image_path}")  # Depuración
    try:
...
class AppExamenes:
    def __init__(self, root):
        ...
        print(f"Ruta de icono_ventana_path: {icono_ventana_path}")  # Depuración
        ...
        # Logo de ENS - Inferior derecha
        ens_logo_path = resource_path(os.path.join("imagenes", "ens_logo.png"))
        print(f"Ruta de ens_logo_path: {ens_logo_path}")  # Depuración
        try:
        ...
        # Logo de Iron Priest (IT) - Inferior izquierda
        it_logo_path = resource_path(os.path.join("imagenes", "ironpriest.png"))
        print(f"Ruta de it_logo_path: {it_logo_path}")  # Depuración
        try:
            ...
            logging.error(f"Error al cargar el logo de Iron Priest ({it_logo_path}): {e}")
            it_label = tk.Label(frame, text="Logo no disponible", font=("Helvetica", 10), bg="#f0f4f8", fg="#003087")
            it_label.place(relx=0.0, rely=1.0, anchor="sw")

        # Logo de Copyright - Inferior centro
        cr_logo_path = resource_path(os.path.join("imagenes", "copyright.png"))
        print(f"Ruta de cr_logo_path: {cr_logo_path}")  # Depuración
        try:
            cr_img = Image.open(cr_logo_path)
            cr_img = cr_img.resize((100, 120), Image.LANCZOS)  # Ajustado para consistencia
            ...
            logging.error(f"Error al cargar el logo de Copyright ({cr_logo_path}): {e}")
            cr_label = tk.Label(frame, text="Logo no disponible", font=("Helvetica", 10), bg="#f0f4f8", fg="#003087")
            cr_label.place(relx=0.5, rely=1.0, anchor="s")  # Corregido anchor
    ...
    def generar_examenes(self):
        ...
        icono_ventana_path = resource_path("ironpriest.ico")
        print(f"Ruta de icono_ventana_path (secundaria): {icono_ventana_path}")  # Depuración
        if os.path.exists(icono_ventana_path):
            try:
